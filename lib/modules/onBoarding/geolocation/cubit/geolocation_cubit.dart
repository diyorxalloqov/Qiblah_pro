...
class GeolocationCubit extends Cubit<GeolocationState> {
  ...
  // void isPrecise() async {
  //   bool isPreciseLoc = await _geolocationManager.isPrecise();
  //   print("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAa");
  //   emit(state.copyWith(isPreciseQibla: isPreciseLoc));
  // }
  ...
  void saveLocationAuto(
    ...
    await StorageRepository.putString(
        Keys.country, autoChoiceLocationModel?.country?.nameNative ?? '');
    await StorageRepository.putString(
        Keys.capital, autoChoiceLocationModel?.city?.name ?? '');
    await StorageRepository.putDouble(

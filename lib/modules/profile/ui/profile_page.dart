...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    // // MediaQuery.of(context).platformBrightness == Brightness.dark;
    // print(_onChanged);
    selectedChipIndex = StorageRepository.getBool(Keys.isMan) ? 1 : 0;
                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          Container(
                              ...
                              child: Column(
                                children: [
                                  SpaceHeight(height: context.height * 0.04),
                                  Text(
                      ...
                      Positioned(
                          ...
                          child: Container(
                            ...
                            child: Center(
                                child: Text(
                              StorageRepository.getString(Keys.name).isNotEmpty
                                  ? StorageRepository.getString(Keys.name)
                                      .substring(0, 1)
                                  : '',
                              style: TextStyle(
